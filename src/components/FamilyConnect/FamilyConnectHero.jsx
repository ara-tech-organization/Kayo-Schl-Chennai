...
import { ArrowRight, Heart, Home, MessageCircle, Star, Users } from "lucide-react";
...
const SHAPES = [
  { type: "blob", color: "var(--color-primary-light)", size: 170, top: "6%", left: "-2%", speed: 0.3, float: 20, dur: 8 },
  { type: "blob", color: "var(--color-secondary-light)", size: 140, top: "10%", right: "-3%", speed: 0.24, float: 16, dur: 9 },
  { type: "star", color: "var(--color-gold)", size: 32, top: "16%", left: "8%", speed: 0.36, float: 18, dur: 6, rotate: 16 },
  { type: "plus", color: "var(--color-orange)", size: 22, top: "24%", right: "10%", speed: 0.44, float: 14, dur: 5, opacity: 0.8 },
  { type: "dot", color: "var(--color-secondary)", size: 18, bottom: "20%", left: "12%", speed: 0.5, float: 22, dur: 6, opacity: 0.7 },
  { type: "squiggle", color: "var(--color-primary)", size: 66, bottom: "24%", right: "10%", speed: 0.3, float: 12, dur: 7, opacity: 0.4 },
];
...
const STATS = [
  { icon: Star, value: 4.9, decimals: 1, suffix: "★", label: "Family rating", tone: "gold" },
  { icon: Users, value: 1000, suffix: "+", label: "Happy families", tone: "secondary" },
  { icon: Home, value: 10, suffix: "+", label: "Years together", tone: "primary" },
];
...
export default function FamilyConnectHero() {
  return (
    <section className="fc-hero">
      ...
      <div className="container fc-hero__head">
        <motion.nav
        ...
        <motion.p
          className="fc-hero__lead fc-hero__lead--muted"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.75, delay: 0.66, ease: EASE }}
        >
          Research shows that when families are involved in preschool education, children develop
          stronger social skills, higher self-confidence, and better academic outcomes — so we have
          built a nurturing community where parents are genuinely part of the journey.
        </motion.p>
